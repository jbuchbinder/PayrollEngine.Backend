...
CREATE UNIQUE INDEX IX_EmployeeDivision_Unique             ON "EmployeeDivision" (EmployeeId, DivisionId);
...
CREATE        INDEX IX_LookupValue_Key                      ON "LookupValue" (KeyHash);
...
CREATE UNIQUE INDEX IX_PayrollLayer_UniqueLevelAndPriority  ON "PayrollLayer" (Level, Priority, PayrollId);
CREATE UNIQUE INDEX IX_PayrollLayer_UniqueName             ON "PayrollLayer" (RegulationName, PayrollId);
...
CREATE UNIQUE INDEX IX_Payrun_UniqueNamePerPayroll          ON "Payrun" (Name, PayrollId);
...
CREATE UNIQUE INDEX IX_PayrunParameter_UniqueNamePerPayrun  ON "PayrunParameter" (PayrunId, Name);
...
CREATE UNIQUE INDEX IX_RegulationShare_Unique               ON "RegulationShare" (ProviderTenantId, ProviderRegulationId, ConsumerTenantId, ConsumerDivisionId);
CREATE        INDEX IX_RegulationShare_Consumer_Provider    ON "RegulationShare" (ConsumerTenantId, ProviderRegulationId, IsolationLevel);
...
CREATE UNIQUE INDEX IX_ReportTemplate_UniqueLanguage        ON "ReportTemplate" (ReportId, Culture);
CREATE UNIQUE INDEX IX_ReportTemplate_UniqueTemplate        ON "ReportTemplate" (ReportId, Name);
